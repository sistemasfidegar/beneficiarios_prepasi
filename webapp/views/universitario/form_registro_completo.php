       ...
       $().ready(function() {
				                 ...
				                 success: function (data) {
				                     ...
				                     if(data === 'ok')
				                     {
				                    	 swal({
				                          	...
				                          	function(isConfirm){
				                          	  if (isConfirm) {
				                          		irA('index.php/registro_uni/registrado');
				                          	  } 
				                          	});
				                     }
				                     else
		...
		function irA(uri) {
  		...
  		<div class="register-container container">
            <div class="row">                
                <div class="register">
                    <form role="form" id="registra_beneficiario" name="registra_beneficiario" action="guardaUniversitario" method="post">
	                    ...
	                    <div id="datos_beneficiario" style="text-align:center; padding-top:10px;">
		                        ...
		                        <div class="form-group">
		                        	...
		                        	<input type="hidden" id="id_institucion" name="id_institucion" value="<?php echo $id_institucion;?>">
		                        	...
		                        	<table width="100%" border="0">		                        	
		                        		<tr>		                        			
		                        			<td colspan="5" height="41px" align="center" valign="top" style="font-size:24px; font-weight:bold; color:#e6007e;">
		                        				...
		                        				<input type="hidden" id="ap" name="ap" value="<?php echo $ap;?>">
		                        				<input type="hidden" id="am" name="am" value="<?php echo $am;?>">
		                        		...
		                        		<tr>		                        			
		                        			<td width="20%" align="center"><?php echo $curp;?><input type="hidden" id="curp" name="curp" value="<?php echo $curp;?>"></td>
		                        			
		                        			<td width="20%" align="center"> <?php echo $fecha_nac;?><input type="hidden" id="fecha_nac" name="fecha_nac" value="<?php echo $fecha_nac;?>"></td>
		                        			
		                        			<td width="20%" align="center"><?php echo $lugar_nac;?><input type="hidden" id="lugar_nac" name="lugar_nac" value="<?php echo $lugar_nac;?>">
		                        			</td>
		                        			
		                        			<td width="20%" align="center"><?php echo $edad;?><input type="hidden" id="edad" name="edad" value="<?php echo $edad;?>"></td>
		                        			
		                        			<td width="20%" align="center"> <?php if($sexo==1){echo 'HOMBRE';}elseif($sexo==2){echo 'MUJER';}?><input type="hidden" id="sexo" name="sexo" value="<?php echo $sexo;?>"></td>
		                        	...
		                        	<table width="100%" border="0">	
		                        		<tr>
		                        			<td  width="50%" align="center">
		                        				<div class="grupo">
		                        					<input type="text"   id="email1" name="email1" style="text-transform:uppercase;" placeholder="Correo electrónico" value="<?php echo $dato['email'];?>" title="flower" class="form-control"><!-- placeholder="Correo electrónico" -->
		                        				</div>
		                        			</td>
		                        			
		                        			<td  width="50%" align="center">
		                        				<div class="grupo">
		                        					<input type="text"  id="email2" name="email2"  style="text-transform:uppercase;" placeholder="Confirma tu correo electrónico" value="" class="form-control"><!-- placeholder="Confirma tu correo electrónico" -->
		                        				</div>
		                        			</td>		                        					                        					                        			
		                        		</tr>	                        			                        				                        		
		                        		<tr>
		                       ...
		                       <div class="grupo">
		                       		<table width="100%" border="0">
		                       					...
		                       					<select id="id_carrera" name="id_carrera" class="form-control"  style="width: 90%;">
						                        	...
						                        	<?php 
						                        		foreach ($carrera as $value){
						                        			$selected="";
						                        			if(in_array($dato['id_carrera_uni'],$value))
						                        				$selected="selected";
						                        	?>
						                        	<option value="<?php echo $value['id_carrera_uni']?>" <?php echo $selected;?>><?php echo $value['carrera']?></option>
						                        	<?php }?>
						                        </select>
		                       				</td>
		                       				<td style="color:red;" align="center" width="20%">
		                       					<label>*Ciclo de ingreso a Universidad</label>
		                       			...
		                       			<tr>
		                       				...
		                       				<td style="color:red;" align="center" colspan="2" width="20%">
		                       				...
		                       				<td style="color:red;" align="center" width="20%">
		                       					...
		                       					<select id="id_grado" name="id_grado" class="form-control"  style="width: 80%;">
						                        	...
						                        	<?php foreach ($grado as $value){
						                        		$selected="";
						                        			if(in_array($dato['id_grado_uni'],$value))
						                        				$selected="selected";	?>
						                        	<option value="<?php echo $value['id_grado_uni']?>" <?php echo $selected;?>><?php echo $value['grado'].' - '.$value['periodicidad'];?></option>
						                        	<?php }?>
						                        </select>
		                       				</td>
		                       				<td style="color:red;" align="center" width="20%">
