       ...
       $().ready(function() {
		   ...
		   var rules_form = {
			        rules: {
						...
						id_grado: "selectNone",
				        id_turno: "selectNone",
				        id_institucion: "selectNone",
				        id_entidad:"selectNone"	
		 ...
		 jQuery.validator.addMethod("selectNone",function (value, element)
		{
		 ...
		 $("#correcion_beneficiario").validate(rules_form);
		...
		$("#id_delegacion").change(function () {
			var delegacion = $("#id_delegacion option:selected").val();
	        	...
	        	jQuery.ajax({
		            type: 'post',
		            dataType: 'html',
		            url: 'correccion/ajaxGetColonias/'+delegacion,
		            data: {operacion: 'ajax'},
		...
		$("#id_institucion").change(function () {
			var id_institucion = $("#id_institucion option:selected").val();
	        	$("#id_grado").html('<option value="0">Cargando...</option>');
	        	jQuery.ajax({
		            type: 'post',
		            dataType: 'html',
		            url: 'correccion/ajaxGetGrado/'+id_institucion,
		            data: {operacion: 'ajax'},
		            success: function (data) {
		                $("#id_grado").html(data);	               
		            }
		...
		$("#id_institucion").change(function () {
			var id_institucion = $("#id_institucion option:selected").val();
			$("#id_plantel").html('<option value="0">Cargando...</option>');
        	jQuery.ajax({
	            type: 'post',
	            dataType: 'html',
	            url: 'correccion/ajaxPlantel/'+id_institucion,
	            data: {operacion: 'ajax'},
	            success: function (data) {
	                $("#id_plantel").html(data);	               
	            }
	        });      
		});
		 ...
		 $("#guardar").click(function ()
			{ 
				if($('#correcion_beneficiario').valid()) 
			     {
					$.blockUI({message: 'Procesando por favor espere...'});
				    $.ajax({
				    	type: 'POST',
				        url: $('#correcion_beneficiario').attr("action"),
				        data: $('#correcion_beneficiario').serialize(),
				        success: function (data) {
...
<?php ?>
 	<div class="register-container container">
            <div class="row">                
                <div class="register">
                    <form role="form" id="correcion_beneficiario" name="correcion_beneficiario" action="correccion/guardaBeneficiario" method="post">
	                    ...
	                    <div id="datos_beneficiario" style="text-align:center; padding-top:10px;">
		                        ...
		                        <div class="form-group">
		                        	...
		                        	<input type="hidden" id="reg_direccion" name="reg_direccion" value="<?php echo $reg_direccion;?>">
		                        	<input type="hidden" id="reg_escolar" name="reg_escolar" value="<?php echo $reg_escolar;?>">
		                        	<input type="hidden" id="id_archivo" name="id_archivo" value="<?php echo $beneficiario['id_archivo'];?>">
		                        	...
		                        	<table width="100%" border="0">		                        	
		                        		<tr>		                        			
		                        			<td colspan="5" height="41px" align="center" valign="top" style="font-size:24px; font-weight:bold; color:#e6007e;">
		                        				<?php echo $beneficiario['nombre']." ".$beneficiario['ap']." ".$beneficiario['am'];?>
		                        		...
		                        		<tr>		                        			
		                        			<td width="20%" align="center"><?php echo $personal['curp'];?><input type="hidden" id="curp" name="curp" value=""></td>
		                        			
		                        			<td width="20%" align="center"> <?php echo $personal['fecha_nacimiento'];?><input type="hidden" id="fecha_nac" name="fecha_nac" value=""></td>
		                        			...
		                        			?>
		         								<select id="id_entidad" name="id_entidad" class="form-control"  style="width: 90%;">
						                        	<option value="-1">[Seleccionar]</option>
						                        	<?php 
						                        		foreach ($entidad as $value){
						                        	?>
						                        		<option value="<?php echo $value['id_entidad'];?>"><?php echo $value['estado'];?></option>
						                        	<?php }?>
						                        </select>
		                        			<?php
		                        				}
		                        			...
		                        			<td width="20%" align="center"><?php echo $personal['edad'];?><input type="hidden" id="edad" name="edad" value=""></td>
		                        			
		                        			<td width="20%" align="center"> <?php if ($personal['id_sexo']==1)echo 'HOMBRE'; else echo 'MUJER';?></td>
		                        		...
		                        		<td align="center">
			                        		<table width="100%" border="0">	
				                        		<tr>
				                        			...
				                        			<?php
// 					                        					$dis='';
// 					                        						if($personal['id_discapacidad'] !=0 || $personal['id_discapacidad'] != null)
// 					                        							$dis='checked';
													?>
				                        				<input type="checkbox" id="es_discapacitado" name="es_discapacitado" data-toggle="toggle" data-on="SI" data-off="NO" data-size="mini" data-onstyle="danger" data-width="80" <?php //echo $dis;?>>                       			
				                        			</td>		                        					                        		              					                        					                        		
				                        		</tr>	                        			                        				                        				                        		
				                        	</table>
					                        		...
					                        		<tr>
					                        			...
					                        			<td width="" align="left">
					                        				<select id="id_discapacidad" name="id_discapacidad" class="form-control" style="width: 50%;">
					                        					...
					                        					<option <?php if($personal['id_discapacidad']==1){ echo "selected='selected'";} ?>value="1">AUDITIVA</option>
																<option <?php if($personal['id_discapacidad']==2){ echo "selected='selected'";} ?>value="2">MOTRIZ</option>
																<option <?php if($personal['id_discapacidad']==3){ echo "selected='selected'";} ?>value="3">INTELECTUAL</option>
																<option <?php if($personal['id_discapacidad']==4){ echo "selected='selected'";} ?>value="4">VISUAL</option>
															</select>
					                        			</td>		                        					                        					                        			
					                        		</tr>	                        			                        				                        				                        		
					                        	</table>
				                        				...
				                        				<select id="id_etnia" name="id_etnia" class="form-control" style="width: 50%;">
				                        					...
				                        					<?php 
				                        						foreach ($grupo_etnico as $value){
				                        							$selected="";
				                        							if(in_array($personal['id_grupo_etnico'],$value))
				                        								$selected="selected";
				                        					?>
		                        		...
		                        		<tr>
		                        			<td width="33%" align="center">
		                        				<select id="id_estado_civil" name="id_estado_civil" class="form-control" style="width: 50%;">
		                        					...
		                        					<option <?php if($personal['id_estado_civil']==1){ echo "selected='selected'";} ?>value="1">Soltero(a)</option>
													<option <?php if($personal['id_estado_civil']==2){ echo "selected='selected'";} ?>value="2">Casado(a)</option>
													<option <?php if($personal['id_estado_civil']==3){ echo "selected='selected'";} ?>value="3">Divorciado(a)</option>
													<option <?php if($personal['id_estado_civil']==4){ echo "selected='selected'";} ?>value="4">Viudo(a)</option>
													<option <?php if($personal['id_estado_civil']==5){ echo "selected='selected'";} ?>value="5">Union libre</option>
		                        			...
		                        			<td width="33%" align="center">
		                        				<select id="id_hijos" name="id_hijos" class="form-control" style="width: 50%;">
		                        					<option <?php if($personal['id_hijos']==0){ echo "selected='selected'";} ?> value="0"> Sin hijos </option>
		                        					<option <?php if($personal['id_hijos']==1){ echo "selected='selected'";} ?> value="1">Uno</option>
													<option <?php if($personal['id_hijos']==2){ echo "selected='selected'";} ?> value="2">Dos</option>
													<option <?php if($personal['id_hijos']==3){ echo "selected='selected'";} ?> value="3">Tres</option>
													<option <?php if($personal['id_hijos']==4){ echo "selected='selected'";} ?> value="4">Cuatro</option>
													<option <?php if($personal['id_hijos']==5){ echo "selected='selected'";} ?> value="5">Cinco</option>
													<option <?php if($personal['id_hijos']==6){ echo "selected='selected'";} ?> value="6">Seis</option>
													<option <?php if($personal['id_hijos']==7){ echo "selected='selected'";} ?> value="7">Siete</option>
													<option <?php if($personal['id_hijos']==8){ echo "selected='selected'";} ?> value="8">Ocho</option>
													<option <?php if($personal['id_hijos']==9){ echo "selected='selected'";} ?> value="9">Nueve</option>
													<option <?php if($personal['id_hijos']==10){ echo "selected='selected'";} ?> value="10">Diez</option>
		                        			...
		                        			<td width="33%" align="center">
		                        				<select id="id_ocupacion" name="id_ocupacion" class="form-control" style="width: 50%;">
		                        					...
		                        					<option <?php if($personal['id_ocupacion']==1){ echo "selected='selected'";} ?> value="1">Tareas del hogar
													<option <?php if($personal['id_ocupacion']==2){ echo "selected='selected'";} ?> value="2">Estudiante
													<option <?php if($personal['id_ocupacion']==3){ echo "selected='selected'";} ?> value="3">Artesano(a), obrero(a), trabajador(a) en actividades industriales o manuales
													<option <?php if($personal['id_ocupacion']==4){ echo "selected='selected'";} ?> value="4">Empleado(a) de oficina o trabajador(a) en actividades administrativas o de servicios
													<option <?php if($personal['id_ocupacion']==5){ echo "selected='selected'";} ?> value="5">Comerciante o empleado(a) de comercio
													<option <?php if($personal['id_ocupacion']==6){ echo "selected='selected'";} ?> value="6">Trabajador(a) en actividades agrícolas
													<option <?php if($personal['id_ocupacion']==7){ echo "selected='selected'";} ?> value="7">Trabajador(a) en servicios domésticos
													<option <?php if($personal['id_ocupacion']==8){ echo "selected='selected'";} ?> value="8">Vendedor(a) ambulante
													<option <?php if($personal['id_ocupacion']==9){ echo "selected='selected'";} ?> value="9">Trabajador(a) por cuenta propia
													<option <?php if($personal['id_ocupacion']==10){ echo "selected='selected'";} ?> value="10">Conductor(a) de medio de transporte
													<option <?php if($personal['id_ocupacion']==11){ echo "selected='selected'";} ?> value="11">Trabajador(a) en servicios de seguridad y fuerzas armadas
													<option <?php if($personal['id_ocupacion']==12){ echo "selected='selected'";} ?> value="12">Maestro(a) docente o trabajador(a) de la educación
													<option <?php if($personal['id_ocupacion']==13){ echo "selected='selected'";} ?> value="13">Profesionista o técnico(a) independiente
													<option <?php if($personal['id_ocupacion']==14){ echo "selected='selected'";} ?> value="14">Lider o directivo(a) del sector social o civil
													<option <?php if($personal['id_ocupacion']==15){ echo "selected='selected'";} ?> value="15">Funcionario(a) del sector público
													<option <?php if($personal['id_ocupacion']==16){ echo "selected='selected'";} ?> value="16">Empresario(a), gerente o directivo(a) de empresa
													<option <?php if($personal['id_ocupacion']==17){ echo "selected='selected'";} ?> value="17">Jubilado(a)/pensionado(a)
													<option <?php if($personal['id_ocupacion']==18){ echo "selected='selected'";} ?> value="18">Desempleado(a)/buscador(a) de trabajo
													<option <?php if($personal['id_ocupacion']==19){ echo "selected='selected'";} ?> value="19">Otra ocupación no especificada
		                        	...
		                        	<table width="100%" border="0">	
		                        		<tr>
		                        			<td  width="50%" align="center">
		                        				<div class="grupo">
		                        					<input type="text"   id="email1" name="email1" placeholder="Correo electrónico" value="<?php echo $personal['email'];?>" title="flower" class="form-control"><!-- placeholder="Correo electrónico" -->
		                        				</div>
		                        			</td>
		                        			
		                        			<td  width="50%" align="center">
		                        				<div class="grupo">
		                        					<input type="text" id="email2" name="email2"  placeholder="Confirma tu correo electrónico" value="<?php echo $personal['email'];?>" class="form-control"><!-- placeholder="Confirma tu correo electrónico" -->
		                        				</div>
		                        			</td>		                        					                        					                        			
		                        		</tr>	                        			                        				                        		
		                        		<tr>
				                        	...
				                        	<select id="id_colonia" name="id_colonia" class="form-control" width="80%" style="width: 80%;">
				                        		...
				                        		<?php
				                        			foreach ($colonias as $value){
				                        				$selected="";
						                        		if(in_array($direccion['id_colonia'],$value))
						                        			$selected="selected";
						                        	?>
		                       ...
		                       <br>			                        		                      	         	                      
		                        ...
		                        <table width="100%" border="0">	
			                        ...
			                        <tr>
			                        	...
			                        	<td align="center"  width="30%"><div class="grupo"><input type="text" id="calle" name="calle" style="text-transform:uppercase;" placeholder="Calle" value="<?php echo $direccion['calle'];?>" style="width: 100%;" ></div></td>
			                        	<td rowspan="2" width="1%"></td>
			                        	<td width="5%"><input type="text" id="noext" name="noext"  style="width: 90%;" value="<?php echo $direccion['noext'];?>"></td>
			                        	<td width="1%"></td>
			                        	<td width="5%"><input type="text" id="noint" name="noint"  style="width: 90%;" value="<?php echo $direccion['noint'];?>"></td>
				                        <td align="center" width="20%">
				                        	<div class="grupo">
				                        	<select id="id_residencia" name="id_residencia" class="form-control" style="width: 80%;">
					                        	<option value="99">No sabe/sin respuesta</option>
					                        	<option <?php if($direccion['id_tiempo_residencia']==1){ echo "selected='selected'";} ?> value="1">Menos de 6 meses</option>
												<option <?php if($direccion['id_tiempo_residencia']==2){ echo "selected='selected'";} ?> value="2">6 meses a 1 año</option>
												<option <?php if($direccion['id_tiempo_residencia']==3){ echo "selected='selected'";} ?> value="3">1 a 3 años</option>
												<option <?php if($direccion['id_tiempo_residencia']==4){ echo "selected='selected'";} ?> value="4">3 a 5 años</option>
												<option <?php if($direccion['id_tiempo_residencia']==5){ echo "selected='selected'";} ?> value="5">5 a 8 años</option>
												<option <?php if($direccion['id_tiempo_residencia']==6){ echo "selected='selected'";} ?> value="6">8 a 12 años</option>
												<option <?php if($direccion['id_tiempo_residencia']==7){ echo "selected='selected'";} ?> value="7">12 a 20 años</option>
												<option <?php if($direccion['id_tiempo_residencia']==8){ echo "selected='selected'";} ?> value="8">20 años o mas</option>
												 <!-- <option value="99">No sabe/sin respuesta</option> -->
					                        </select>
					                        </div>
			                        	</td>
		                    ...
		                    <div class="grupo">
		                    	<table width="100%" border="0">	
			                        ...
			                        <tr>
		                        		<td  width="50%" align="center"><input type="text" style="text-transform:uppercase;" id="ecalle" name="ecalle"  value="<?php echo $direccion['ecalle'];?>"></td>
		                        		<td  width="50%" align="center"><input type="text" style="text-transform:uppercase;" id="ycalle" name="ycalle"  value="<?php echo $direccion['ycalle'];?>"></td>		                        					                        					                        			
		                        	</tr>
		                   ...
		                   <div class="grupo">
		                   	<table width="100%" border="0">	
			                   	...
			                   	<tr>
			                        <td width="3%"><input type="text" id="edificio" name="edificio"  style="width: 90%;" value="<?php echo $direccion['edificio'];?>"></td>
			                        <td width="3%"><input type="text" id="departamento" name="departamento"  style="width: 90%;" value="<?php echo $direccion['departamento'];?>"></td>
			                        <td width="3%"><input type="text" id="manzana" name="manzana"  style="width: 90%;" value="<?php echo $direccion['manzana'];?>"></td>
			                        <td width="3%"><input type="text" id="lote" name="lote"  style="width: 90%;" value="<?php echo $direccion['lote'];?>"></td>
			                        <td width="3%"><input type="text" id="rampa" name="rampa"  style="width: 90%;" value="<?php echo $direccion['rampa'];?>"></td>
			                   	</tr>
			               </table>
			               <table width="100%" border="0">
			                   	<tr>
			                   	...
			                   	<tr>
			                        ...
			                        <td width="3%"><input type="text" id="pasillo" name="pasillo"  style="width: 90%;" value="<?php echo $direccion['pasillo'];?>"></td>
			                        <td width="3%"><input type="text" id="villa" name="villa"  style="width: 90%;" value="<?php echo $direccion['villa'];?>"></td>
			                        <td width="3%"><input type="text" id="entrada" name="entrada"  style="width: 90%;" value="<?php echo $direccion['entrada'];?>"></td>
			                        <td width="3%"><input type="text" id="andador" name="andador"  style="width: 90%;" value="<?php echo $direccion['andador'];?>"></td>
			                        <td width="3%"><input type="text" id="telefono" name="telefono" maxlength="8"  style="width: 70%;" value="<?php echo $personal['telefono'];?>"></td>
			                        <td width="3%">044-55<input type="text" id="celular" name="celular" maxlength="8"  style="width: 70%;" value="<?php echo $personal['celular'];?>"></td>
		                   ...
		                   <hr/>
		                       ...
		                       <div class="grupo">
		                       		<table width="100%" border="0">
		                       			...
		                       			<tr>
		                       				...
		                       				<td  width="15%" align="center"><input type="text" style="text-transform:uppercase;" id="apellidoPadreP" name="apellidoPadreP"  placeholder="Apellido Paterno" value="<?php echo $personal['ap_p'];?>"></td>
		                        			<td  width="15%" align="center"><input type="text" style="text-transform:uppercase;" id="apellidoPadreM" name="apellidoPadreM"  placeholder="Apellido Materno" value="<?php echo $personal['am_p'];?>"></td>
		                        			<td  width="15%" align="center" ><input type="text" style="text-transform:uppercase;" id="nombrePadre" name="nombrePadre"  placeholder="Nombre" value="<?php echo $personal['nombre_p'];?>"></td>
		                       			...
		                       			<tr>
		                       				...
		                       				<td  width="15%" align="center"><input type="text" style="text-transform:uppercase;" id="apellidoMadreP" name="apellidoMadreP"  placeholder="Apellido Paterno" value="<?php echo $personal['ap_m'];?>"></td>
		                        			<td  width="15%" align="center"><input type="text" style="text-transform:uppercase;" id="apellidoMadreM" name="apellidoMadreM"  placeholder="Apellido Materno" value="<?php echo $personal['am_m'];?>"></td>
		                        			<td  width="15%" align="center"><input type="text" style="text-transform:uppercase;" id="nombreMadre" name="nombreMadre"  placeholder="Nombre" value="<?php echo $personal['nombre_m'];?>"></td>
		                       			</tr>
	                        ...
	                        <div id="dotos_escolares">
		                       ...
		                       <div class="grupo">
		                       		...
		                       		<?php if ($reg_escolar!=0){?>
		                       				<td colspan="4"><input type="text" id="institucion" name="institucion"   style="width: 100%;" value="<?php echo '  '.$escolar['institucion'];?>" readonly></td>
		                       				<?php }
		                       		      else{ ?>
		                       		      <td colspan="4">
		                       		    		<select id="id_institucion" name="id_institucion" class="form-control"  style="width: 70%;">
						                        	<option value="-1">[Seleccionar]</option>
						                        	<?php 
						                        		foreach ($institucion as $value){	
						                           	?>
						                        		<option value="<?php echo $value['id_institucion']?>" ><?php echo $value['institucion']?></option>
						                        	<?php }?>
						                        </select> 
						                       </td> 
			                       				...
			                       				<select id="id_plantel" name="id_plantel" class="form-control"  style="width: 70%;">
						                        	...
						                        	<?php 
						                        		foreach ($plantel as $value){	
						                        			$selected="";
						                        			if(in_array($escolar['id_plantel'],$value))
						                        				$selected="selected";
						                        	?>
		                       			...
		                       			<tr>
		                       					...
		                       					<select id="id_carrera" name="id_carrera" class="form-control"  style="width: 90%;">
						                        	...
						                        	<?php 
						                        		foreach ($carrera as $value){
						                        			$selected="";
						                        			if(in_array($escolar['id_carrera'],$value))
						                        				$selected="selected";
						                        	?>
		                       					...
		                       					<select id="id_ciclo" name="id_ciclo" class="form-control"  style="width: 90%;">
						                        	...
						                        	<?php 
						                        		foreach ($generacion as $value){
						                        			$selected="";
						                        			if(in_array($escolar['id_generacion'],$value))
						                        				$selected="selected";
						                        	?>
		                       				...
		                       				<td align="center" width="20%" style="color:red;">
			                       				...
			                       				<select id="id_sistema" name="id_sistema" class="form-control"  style="width: 90%;">
							                        <option value="-1">[Seleccionar]</option>
							                        <option <?php if($escolar['id_sistema']==1){ echo "selected='selected'";} ?> value="1">Sistema Escolarizado</option>
													<option <?php if($escolar['id_sistema']==2){ echo "selected='selected'";} ?> value="2">Sistema Abierto</option>
													<option <?php if($escolar['id_sistema']==3){ echo "selected='selected'";} ?> value="3">Sistema Mixto</option>
		                       				...
		                       				<td align="center" width="20%" style="color:red;">
		                       					<label>*Promedio (ciclo inmediato anterior)</label>
		                       					      ...
		                       					      {		                       					      	 
		                       					      	if($escolar['promedio']==1){ $prom= "6.00 - 6.50";}
		                       					      	if($escolar['promedio']==2){ $prom= "6.51 - 7.00";}
		                       					      	if($escolar['promedio']==3){ $prom= "7.01 - 7.50";}
		                       					      	if($escolar['promedio']==4){ $prom= "7.51 - 8.00";}
		                       					      	if($escolar['promedio']==5){ $prom= "8.01 - 8.50";}
		                       					      	if($escolar['promedio']==6){ $prom= "8.51 - 9.00";}
		                       					      	if($escolar['promedio']==7){ $prom= "9.01 - 9.50";}
		                       					      	if($escolar['promedio']==8){ $prom= "9.51 - 10.00";}
		                       					      	 
		                       					      
		                       					      ?> 
		   											<input id="promedio" name="promedio" class="form-control" type="text" style="width: 90%;" value="<?php echo $prom;?>"readonly >
		                       					<?php }?>
		                       				</td>
		                       			...
		                       			<tr>
		                       				...
		                       				<td align="center" colspan="2" width="20%" style="color:red;">
		                       					...
		                       					<input type="text" id="matricula" name="matricula"   style="width: 100%;"value="<?php echo $escolar['matricula_escuela'];?>">
		                       				...
		                       				<td style="color:red;" align="center" width="20%">
		                       					...
		                       					<select id="id_grado" name="id_grado" class="form-control"  style="width: 80%;">
						                        	...
						                        	<?php foreach ($grado as $value){
						                        		$selected="";
						                        			if(in_array($escolar['id_grado'],$value))
						                        				$selected="selected";	?>
		                       				...
		                       				<td align="center" width="20%" style="color:red;">
			                       				...
			                       				<select id="id_turno" name="id_turno" class="form-control"  style="width: 90%;">
							                        <option value="-1">[Seleccionar]</option>
							                        <option <?php if($escolar['id_turno']==1){ echo "selected='selected'";} ?> value="1">Matutino</option>
													<option <?php if($escolar['id_turno']==2){ echo "selected='selected'";} ?> value="2">Vespertino</option>
													<option <?php if($escolar['id_turno']==3){ echo "selected='selected'";} ?> value="3">Nocturno</option>
													<option <?php if($escolar['id_turno']==4){ echo "selected='selected'";} ?> value="4">Sabatino</option>
													<option <?php if($escolar['id_turno']==5){ echo "selected='selected'";} ?> value="5">Sin Turno</option>
													<option <?php if($escolar['id_turno']==6){ echo "selected='selected'";} ?> value="6">Mixto</option>
						                        </select>
		                       				</td>
		                       				<td align="top" width="20%">
		                       					<label>Materias que adeuda</label><br>
		                       					<input  type="text" id="materias" name="materias"   style="width: 30%;"value="<?php echo $escolar['num_mat_adeuda'];?>">
		                       				</td>
