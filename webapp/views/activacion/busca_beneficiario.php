            ...
            <div class="row">                
                <div class="register">
                    <form role="form" id="registra_beneficiario" name="registra_beneficiario" action="activacion/buscaBeneficiario" method="post">
			        	...
			        	<tr>
			        		<td>NO HAY ACTIVACIONES DE TARJETA EN ESTE MOMENTO</strong></td>		                        		
			            </tr>
			            <tr><td>&nbsp;&nbsp;</td></tr>
			            <tr><td>&nbsp;&nbsp;</td></tr>
			            <tr>
				...
				<?php } else { ?>
                        <br>
                        <div style="text-align:CENTER !important;"><label class="leyenda" style="color:#E6007E; font-size: 180%;"> ACTIVACI&Oacute;N DE TARJETAS </label></div>	
