                        ...
                        <div style="text-align:center; padding-top:20px;">
	                        ...
	                        <div id="dotos_personales">
	         	            ...
	         	            <div id="dotos_domicilio">           
	                        	...
	                        	<input type="text" id="calle" name="calle" placeholder="Calle" value="<?php echo $direccion['calle']; ?>" style="width:39%;" title="Calle" readonly >
	                        	...
	                        	<input type="text" id="andador" name="andador" placeholder="Andador" value="<?php echo $direccion['andador']; ?>" title="Andador" style="width:9%;" readonly >
	                        	<input type="text" id="rampa" name="rampa" placeholder="Rampa" value="<?php echo $direccion['rampa']; ?>" title="Rampa" style="width:10%;" readonly >
	                        	<input type="text" id="pasillo" name="pasillo" placeholder="Pasillo" value="<?php echo $direccion['pasillo']; ?>" title="Pasillo" style="width:9%;" readonly >
	                        	<input type="text" id="villa" name="villa" placeholder="Villa" value="<?php echo $direccion['villa']; ?>" title="Villa" style="width:9%;" readonly >
	                        	<input type="text" id="entrada" name="entrada" placeholder="Entrada" value="<?php echo $direccion['entrada']; ?>" title="Entrada" style="width:9%;" readonly >
	                        	<input type="text" id="colonia" name="colonia" placeholder="Colonia" value="<?php echo strtoupper($direccion['colonia']); ?>" title="Colonia" style="width:33%;" readonly >
	                        	<br />
