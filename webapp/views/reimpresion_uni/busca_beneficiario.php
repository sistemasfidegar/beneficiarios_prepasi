    		...
    		$("#guardar").click(function () {
    			if($("#matricula_asignada").val() != ""  ) //&& $("#matricula_asignada").val()
    	        {
    	        	...
    	        	jQuery.ajax({
    		            type: 'post',
    		            dataType: 'html',
    		            url: 'reimpresion_uni/ajax_beneficiario_matricula',
    		            ...
    		            success: function (data) {
        		            ...
        		            {
	    		            	matricula = data;
	    		            	irA('reimpresion_uni/buscaBeneficiario/'+matricula);	               
        		            }
        		            else
        		            {
    	        	...
    	        	jQuery.ajax({
    		            type: 'post',
    		            dataType: 'html',
    		            url: 'reimpresion_uni/ajax_beneficiario_unam',
        ...
        function irA(uri) {
         ...
         <div class="register-container container">
            <div class="row">                
                <div class="register">
                    <form role="form" id="registra_beneficiario" name="registra_beneficiario" action="reimpresion_uni/buscaBeneficiario" method="post">
                        ...
                        <br>
                         <div style="text-align:CENTER !important;"><label class="leyenda" style="color:#E6007E; padding-left:20px;"> REIMPRESIÓN DE DOCUMENTOS UNIVERSIDAD</label></div>	
